      ...
      >
        ...
        <div className="relative space-y-8">
          ...
          <div className="inline-flex">
            ...
            >
              <Plus className="w-8 h-8 md:w-9 md:h-9 text-white" strokeWidth={2.5} />
            </div>
          </div>
      ...
      >
        ...
        <div className="relative space-y-8 h-full flex flex-col">
          ...
          <div className="inline-flex">
            ...
            >
              <Users className="w-8 h-8 md:w-9 md:h-9 text-white" strokeWidth={2.5} />
            </div>
          </div>
          ...
          <div className="space-y-4 flex-1 flex flex-col justify-end">
            ...
            <Button
              ...
              className="w-full h-14 rounded-[1.25rem] relative overflow-hidden disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-200"
              style={{
