    ...
    <div className="min-h-screen px-4 pt-6 pb-28 bg-white text-black dark:bg-neutral-950 dark:text-white transition-all flex flex-col justify-between font-sans">
      <div>
        ...
        <div className="mb-8 px-2">
          ...
          <div className="w-32 h-1.5 mt-2 bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 rounded-full animate-pulse" />
        </div>
      ...
      {/* Updated Footer Branding to match Search */}
      <div className="mt-12 flex justify-center items-center gap-2 text-sm">
        ...
        <span className="text-[15px] font-medium text-gray-400 dark:text-gray-400">Vibie</span>
      </div>
    </div>
  );
};
