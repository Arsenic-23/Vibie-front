...
export default function ProfilePopup() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2">
      ...
      {/* Popup Content */}
      <div className="relative z-50 w-80 bg-white/90 dark:bg-[#111111] backdrop-blur-lg p-6 rounded-2xl shadow-2xl space-y-6 border border-gray-200 dark:border-gray-800 transition-all duration-300">
        {/* Tabs */}
